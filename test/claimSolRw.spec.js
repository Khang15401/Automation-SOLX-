...
(async function claimSolRwTest() {
    ...
    try {
      ...
      let connectButton1 = await driver.findElement(By.xpath('//*[@id="app"]/div[1]/div/nav/div/div[3]/button[2]/div'));
        ...
        let solflareButton1 = await driver.findElement(By.xpath('//*[@id="v-menu-4"]/div/div/div[1]'));
      ...
      let claimSolRwSection = await driver.findElement(By.xpath('//*[@id="link"]/div/div[2]/div/section/div[2]/div/div[2]/div/div[1]/button[1]'));
      await driver.executeScript("arguments[0].scrollIntoView(true);", claimSolRwSection);

      let claimSolRwButton = await driver.findElement(By.xpath('//*[@id="link"]/div/div[2]/div/section/div[2]/div/div[2]/div/div[2]/div/button/div'));
      
      await sleep(3000);
      
      await driver.executeScript("arguments[0].click();", claimSolRwButton)
