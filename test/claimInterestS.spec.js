...
( async function claimInterSTest() {
    let driver;
     ...
     try {
        ...
        let solflareButton = await driver.findElement(By.xpath('//*[@id="v-menu-4"]/div/div/div[1]'));
        ...
        let stakeButton = await driver.findElement(By.xpath('//*[@id="home"]/div[2]/div/div[3]/div[2]/div/div[1]/button[3]'));

        await driver.executeScript("arguments[0].scrollIntoView(true);", stakeButton);
        await sleep(3000);
        ...
        let confirmWithdrawnButton = await driver.findElement(By.xpath('//*[@id="home"]/div[2]/div/div[3]/div[2]/div/div[2]/div/div[2]/button[2]/div'));
        await confirmWithdrawnButton.click();
