...
(async function claimSolxRwTest() {
    let driver;
    try {
      ...
      await driver.wait(until.elementLocated(By.xpath('/html/body/div[3]/iframe')), 25000);
      ...
      await driver.wait(until.elementLocated(By.xpath('//*[@id="root"]/div/div[2]/div/div[2]/div[2]/button')), 25000);
      ...
      let claimSolxRwSection = await driver.findElement(By.xpath('//*[@id="link"]/div/div[2]/div/section/div[2]/div/div[2]/div/div[1]/button[2]'));
      await driver.executeScript("arguments[0].scrollIntoView(true);", claimSolxRwSection);
      await driver.executeScript("arguments[0].click();", claimSolxRwSection)
      // await claimSolxRwSection.click();

      let claimSolxRwButton = await driver.findElement(By.xpath('//*[@id="link"]/div/div[2]/div/section/div[2]/div/div[2]/div/div[2]/div/button/div'));
      
      await sleep(3000);
      
      await driver.executeScript("arguments[0].click();", claimSolxRwButton)
